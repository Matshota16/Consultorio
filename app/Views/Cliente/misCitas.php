                    ...
                    <tbody>
                        <?php foreach ($citasFuturas as $index => $cita): ?>
                            <tr>
                                ...
                                <td><a href="<?= base_url('cita/editCliente/' . $cita->idCita); ?> " class="btn btn-warning">Reprogramar</a>
                                <a href="<?= base_url('cita/delete/' . $cita->idCita); ?> " class="btn btn-danger">Cancelar Cita</a>
                            </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
